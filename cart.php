...
<section class="shopping_cart">
  ...
  <div class="cart_box_cont">
    ...
    <div class="cart_box">
      ...
      <p>EGP. <?php echo $fetch_cart['price']; ?></p>
      ...
      <p>Total : <span>EGP.<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?></span></p>
    </div>
    <?php
  ...
  <div class="cart_total">
    <h2>Total Cart Price : <span>EGP. <?php echo $grand_total;?></span></h2>
    <div class="btns_cart">
